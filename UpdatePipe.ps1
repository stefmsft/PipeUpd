Start-Transcript .\lastlogexecution-UpdatePipe.log
try {
    ...
    if ($uvAvailable) {
        ...
        Write-Host "Running UpdatePipe.py with uv..." -ForegroundColor Yellow
        uv run UpdatePipe.py
    }
    else {
        ...
        Write-Host "Running UpdatePipe.py..." -ForegroundColor Yellow
